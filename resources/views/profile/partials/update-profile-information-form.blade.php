<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input id="profile_text" class="block mt-1 w-full" type="text" name="profile_text" value="{{old('profile_text',$user->profile_text)}}">
            <x-input-error :messages="$errors->get('profile_text')" />
        </div>
